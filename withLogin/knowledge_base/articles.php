				...
				<div class="page-content fade-in-up">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            ...
                            <tbody>
                                <?php
                                    $articles = $crud->fetch_data("SELECT * FROM articles_tbl WHERE article_status = '1' ORDER BY date_created ");
                                    foreach($articles as $rows){
                                ?>
                                <tr>
                                    <td><?php echo $rows["article_title"]; ?></td>
                                    <td style="text-align: center;"><?php echo $rows["article_category"]; ?></td>
                                    <td style="text-align: center;"><?php echo $rows["date_created"]; ?></td>
                                    <td style="text-align: center;"><a href="view_ticket.php?ticket_id=<?php echo $rows["id"]; ?>" data-toggle="tooltip" title="Views" class="btn btn-info btn-sm text-light"><i class="fa fa-eye"></i></a> | <a  data-id="<?php echo $rows["id"]; ?>" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-sm text-light delete"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                <?php
                                    }
                                ?>
            ...
            $(".delete").on('click',function(){
                ...
                function(isConfirm) {
                  if (isConfirm) {
                    ...
                    swal("Cancelled", "Article was not deleted!", "error");
                  }
                });
            });
        })
