...
<div class="form-group row">
    ...
    <div class="col-lg-9 form-input">
    	<div class="form-input">
        <input type="text" class="form-control" name="status_bgcolor" id="status_bgcolor" required>
        </div>
 ...
 <div class="form-group row">
    ...
    <div class="col-lg-9 form-input">
    	<div class="form-input">
        <input type="text" class="form-control" name="status_fontcolor" id="status_fontcolor" required>
        </div>
        <small>Enter a hexcode for the color. Leave out the #.</small>
    </div>
</div>
